import random, copy, sys, os, pygame
...
def run():
    ...
    BLACKPILERECT = pygame.Rect(WINDOWWIDTH - int(3 * SPACESIZE / 2), WINDOWHEIGHT - int(3 * SPACESIZE / 2), SPACESIZE,
                                SPACESIZE)
    # Load images relative to this module's directory so the program
    # can be launched from any working directory.
    images_dir = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', 'images'))
    REDTOKENIMG = pygame.image.load(os.path.join(images_dir, '4row_red.png'))
    REDTOKENIMG = pygame.transform.smoothscale(REDTOKENIMG, (SPACESIZE, SPACESIZE))
    BLACKTOKENIMG = pygame.image.load(os.path.join(images_dir, '4row_black.png'))
    BLACKTOKENIMG = pygame.transform.smoothscale(BLACKTOKENIMG, (SPACESIZE, SPACESIZE))
    BOARDIMG = pygame.image.load(os.path.join(images_dir, '4row_board.png'))
    BOARDIMG = pygame.transform.smoothscale(BOARDIMG, (SPACESIZE, SPACESIZE))

    HUMANWINNERIMG = pygame.image.load(os.path.join(images_dir, '4row_humanwinner.png'))
    COMPUTERWINNERIMG = pygame.image.load(os.path.join(images_dir, '4row_computerwinner.png'))
    TIEWINNERIMG = pygame.image.load(os.path.join(images_dir, '4row_tie.png'))
